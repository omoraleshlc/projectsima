...
class Almacenes extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('almacenConsumo, almacen, descripcion, tieneCuartos, ctaContable, fecha1, usuario, modulo, activo, stock, miniAlmacen, almacenPadre, id_medico, entidad, medico, ventas, contieneReferidos, permiteDevoluciones, beneficencia, manejaexpedientes, listaexpedientes, almacenExistencias, precioEspecial, tipoBeneficencia, porcenajePE, horaPE, llenadoEspecial, porcentajePE, ventaBotiquinExternos, imprimeTicket, statusExistencias, ctaMayor', 'required'),
			...
			array('descripcion, reporteSurtir, llenadoEspecial, ctaMayor', 'length', 'max'=>50),
			...
			array('keyAlmacenes, almacenConsumo, almacen, descripcion, tieneCuartos, ctaContable, fecha1, usuario, ID_CCOSTO, modulo, activo, stock, miniAlmacen, almacenPadre, id_medico, entidad, medico, ventas, altaPaciente, altaEspecial, cargosDirectos, numConsultorio, transacciones, contieneReferidos, contieneEmpleados, compras, ventasDirectas, modificarPrecios, cierreCuenta, registroUrgencias, credenciales, medicamentosSueltos, centroDistribucion, permiteDevoluciones, almacenCargo, reporteSurtir, statusCitas, cambiarDescripcion, gpoProducto, puntoVenta, actualizaPrecios, especialidad, maquila, farmacia, beneficencia, manejaexpedientes, listaexpedientes, almacenExistencias, precioEspecial, tipoBeneficencia, porcenajePE, horaPE, llenadoEspecial, porcentajePE, ventaBotiquinExternos, imprimeTicket, statusExistencias, ctaMayor', 'safe', 'on'=>'search'),
		);
	}
