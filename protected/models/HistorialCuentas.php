...
/**
 * This is the model class for table "historialCuentas".
 *
 * The followings are the available columns in table 'historialCuentas':
 ...
 */
class HistorialCuentas extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return HistorialCuentas the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('descripcionMedico, descripcionpaquete', 'length', 'max'=>100),
