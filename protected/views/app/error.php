...
?>
	<p>
    No tienes permiso de acceso a esta página. <strong><a href="<?php echo $this->createUrl('cruge/ui/login'); ?>">Ingresa al sistema</a></strong> o intenta alguna de las sigguientes opciones:
    </p>
    <ul>
		<li><a href="#" onclick="history.go(-2);">Regresar a la página anterior</a></li>
		<li><a href="<?php echo $this->createUrl('site/index'); ?>">Ir a la página principal</a></li>
