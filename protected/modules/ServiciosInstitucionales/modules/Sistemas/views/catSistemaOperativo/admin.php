...
$('.search-form form').submit(function(){
	$('#cat-sistema-operativo-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
...
<h1>Manage Cat Sistema Operativos</h1>
	...
	'columns'=>array(
		'keyOS',
		 array( 
            ...
            'editable' => array(
                'type'      => 'text',
                'url'       => $this->createUrl('catSistemaOperativo/updateEditable', array('model'=>'catMarca', 'field'=>'descripcion')),
                'placement' => 'left',
            	)
       	),  
		array(
