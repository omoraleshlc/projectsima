...
class EquipoOtrosController extends Controller
{
	/**
	...
	public function filters()
   {
	...
	{
		$model=new EquipoOtros;

		// Uncomment the following line if AJAX validation is needed
		// $this->performAjaxValidation($model);

		
		if(isset($_POST['EquipoOtros']))
		{
			$model->attributes=$_POST['EquipoOtros'];
			...
			if($model->save()){
                                Yii::app()->db->createCommand("update sima.sis_inventarioEqOtros set next_mantenimiento = IF(
	...
	{
		$dataProvider=new CActiveDataProvider('EquipoOtros');
	...
	{
		$model=new EquipoOtros('search');
		$model->unsetAttributes();  // clear any default values
		if(isset($_GET['EquipoOtros']))
			$model->attributes=$_GET['EquipoOtros'];
	 ...
	 * @return EquipoOtros the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=EquipoOtros::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param EquipoOtros $model the model to be validated
	 */
	...
	*/
	public function actionUpdateEditable() {
		...
		$es = new EditableSaver('EquipoOtros');
		$es->update();
	}
	...
	*/
	...
	public function actionListLabels()
	{
        ...
        $modelPendientes = new CActiveDataProvider('EquipoOtros', array(
            'criteria' => array(
                'order' => 'keyIE ASC',
            ),
            'pagination' => array(
